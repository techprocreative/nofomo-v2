    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-lg text-card-foreground">ForexAI Pro</h3>
                <p className="text-xs text-muted-foreground">AI Trading Platform</p>
              </div>
            </div>
            <p className="text-sm text-muted-foreground">
              Empowering traders worldwide with AI-driven forex strategies and automated trading solutions.
            </p>
          </div>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">© 2024 ForexAI Pro. All rights reserved.</p>
